...
![บล็อกอ่านข้อมูล 1 ไบต์](https://sv1.picz.in.th/images/2018/12/22/9KTqPI.png)

ใช้อ่านข้อมูล 1 ไบต์ จะให้เอาต์พุตออกมาเป็นตัวเลขรหัสแอสกี้

### บล็อกอ่านข้อมูลเป็น String ตามจำนวนตัวอักษรที่กำหนด

![บล็อกอ่านข้อมูลเป็น String ตามจำนวนตัวอักษรที่กำหนด](https://sv1.picz.in.th/images/2018/12/21/9wvjnS.png)

ใช้อ่านข้อมูลเป็นชุดแบบ String ตามจำนวนตัวอักษรที่กำหนด สามารถนำเอาต์พุตจากบล็อกนี้ ไปใส่บล็อก แอลอีดี 16x8 (ทุกบล็อก) ได้

### บล็อกอ่านข้อความ

![บล็อกอ่านข้อความ](https://sv1.picz.in.th/images/2018/12/22/9KTUZZ.png)
...
![บล็อกอ่านข้อความ 1 บรรทัด](https://sv1.picz.in.th/images/2018/12/22/9KT5mP.png)
...
![บล็อกอ่านข้อความ จำกัดความยาวจากตัวอักษรที่กำหนด](https://sv1.picz.in.th/images/2018/12/22/9KTO9t.png)
 ...
 * คำสั่งอ่านค่าจากบอร์ด จะทำงานช้ากว่าคำสั่งเขียน เพราะคำสั่งอ่านจะทำทีละคำสั่ง แต่คำสั่งเขียนจะทำพร้อมกันครั้งเดียว
